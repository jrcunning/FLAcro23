...
ggsave(mort.fits.v2, filename = "mort.fits.v.png", width = 100, height = 250, units = "mm")
...
mapfig2 <- basemap +
  geom_point(data = dfs2, aes(x = lon, y = lat, color = subregion, size = maxn_cat, shape = species), alpha = 0.4) +
...
# Save
ggsave("outmap3_nospp_new.png", plot = outmap3, width = 183, height = 140, units = "mm")
```
...
ggplot(drc.res, aes(x = cummaxdhw, y = fit, color = species, fill = species)) +
  ...
  labs(x = "Cumulative Maximum DHW", y = "Percent Mortality") +
  theme_classic() +
  scale_color_brewer(palette = "Set2", name = "Species", labels = c("A. cervicornis", "A. palmata")) +
  scale_fill_brewer(palette = "Set2", name = "Species", labels = c("A. cervicornis", "A. palmata")) +
  geom_text(
    data = eds.res, 
...
ggplot(drc.res, aes(x = cummaxdhw, y = fit, color = coral_type, fill = coral_type)) +
  ...
  geom_ribbon(aes(ymin = lower_PI, ymax = upper_PI), alpha = 0.2, linetype = 0) +
  labs(
    title = "Dose-Response Curve with Bootstrap Prediction Intervals",
    x = "Cumulative Maximum DHW",
    y = "Percent Mortality"
  ) +
  theme_minimal() +
  scale_color_brewer(palette = "Set2", name = "Coral Type") +
  scale_fill_brewer(palette = "Set2", name = "Coral Type") +
