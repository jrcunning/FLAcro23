...
write_csv(df, file = "FLAcro23_data_processed.csv")
```
...
##Make table for mortality for each species without subregion
...
ggplot(df, aes(x = cummaxdhw, y = pct_mort)) +
  ...
  geom_line(data = as_tibble(dhwGlmerRes), aes(y = prob, color = species, lty = coral_type))

# plot Just fitted curves
as_tibble(resDhwGlm) %>%
