...
# Include all wild and outplant and mixes (wild/outplant -- only 2 observations)
m3 <- drm(pct_mort ~ cummaxdhw, data = df, curveid = species, weights = n_total, type = "binomial",
