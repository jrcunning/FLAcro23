...
#   labs(x = "", y = "Mortality"))
ggsave(mort.fits.v, filename = "mort.fits.v.png", width = 100, height = 250, units = "mm")
...
### Get mortality of all Acropora over time, since no species diffs at dates of interest
```{r mod_allacro}
...
# Mortality vs. DHW -- ACER vs. APAL, and APAL Wild vs. Outplant
...
# Get ED50s and ED95s
ed_values <- ED(m3, c(0.5, 0.95), type = "absolute", interval = "delta", level = 0.95)
...
bootstrap_function <- function(iteration) {
  ...
  ed_values <- as.tibble(ED(boot_model, c(50, 95), interval = "none"))$Estimate
